...
typedef struct {
    ...
    int32_t AIR_data;
    int32_t ARED_data;
	int32_t IRABSVAL_data;
	int32_t REDABSVAL_data;
    uint32_t spo2;
    uint32_t heart_rate;
    uint8_t buffer_count_overflow;
} afe44xx_data;

typedef struct {
    void (*init)(void);
    void (*read_data)(uint8_t,afe44xx_data*);
} AFE44XX_HandleTypeDef;

extern AFE44XX_HandleTypeDef hAFE44xx;
void afe_read_data(uint8_t reg_addr,afe44xx_data *data1);
